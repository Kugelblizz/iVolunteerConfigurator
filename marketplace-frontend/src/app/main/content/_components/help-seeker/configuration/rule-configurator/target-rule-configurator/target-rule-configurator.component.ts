...
import { AttributeCondition, ClassAction } from 'app/main/content/_model/derivation-rule';
...
export class TargetRuleConfiguratorComponent implements OnInit {
  ...
  @Output('classActionChange') classActionChange: EventEmitter<ClassAction> = new EventEmitter<ClassAction>();
  ...
  private loadClassProperties(classDefinition: ClassDefinition) {
    this.classPropertyService
      .getAllClassPropertiesFromClass(null, classDefinition.id)
      .toPromise()
